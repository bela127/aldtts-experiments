...
from aldtts.modules.selection_criteria import PValueSelectionCriteria, PValueUncertaintySelectionCriteria, TestScoreUncertaintySelectionCriteria, TestScoreSelectionCriteria
...
blueprint = Blueprint(
    ...
    oracle = Oracle(
        data_source=SquareDataSource((2,),(1,)),
    ...
    #evaluators=[LogPValueEvaluator(folder="log_ide")],
